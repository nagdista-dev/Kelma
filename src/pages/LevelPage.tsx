      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <div className="mb-6 flex items-center gap-3">
          <Link
            ...
            className="flex h-9 w-9 shrink-0 cursor-pointer items-center justify-center rounded-lg border border-white/10 text-slate-500 dark:text-gray-400 transition-colors hover:border-teal-500/50 hover:text-teal-300"
          >
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-500 dark:text-gray-400 sm:text-sm">Pick it yourself — or let the AI find it</p>
          </div>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <Card className="p-4 sm:p-5">
            <h2 className="mb-3 text-[11px] font-semibold uppercase tracking-widest text-slate-500 dark:text-gray-400 sm:text-sm">
              Choose manually
            </h2>
                  ...
                  <button
                    ...
                    className={`flex w-full cursor-pointer items-center gap-3 rounded-xl border px-4 py-3 text-left transition-all duration-200 active:scale-[0.99] ${
                      active
                        ...
                        : 'border-slate-200 bg-white hover:border-teal-500/40 dark:border-white/10 dark:bg-white/5'
                    }`}
                  >
                    <span
                      className={`flex h-9 w-11 shrink-0 items-center justify-center rounded-lg text-sm font-extrabold ${
                        active ? 'bg-teal-500 text-white' : 'bg-slate-100 text-slate-600 dark:bg-white/10 dark:text-gray-300'
                      }`}
                    >
                      {level}
                    </span>
                    <span className="min-w-0 flex-1 truncate text-sm text-slate-700 dark:text-gray-200">
          ...
          <Card className="p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-sm font-bold text-slate-900 dark:text-gray-100 sm:text-base">AI Placement Test</h2>
            ...
            {phase.kind === 'loading' && (
              <div className="mt-4 flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-gray-300">
            ...
            {phase.kind === 'test' && (
              <div className="mt-4">
                ...
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <span className="shrink-0 text-[11px] font-bold tabular-nums text-slate-500 dark:text-gray-500">
            ...
            {phase.kind === 'result' && (
              ...
              >
                ...
                <p className="mt-2 text-sm text-slate-600 dark:text-gray-300">{LEVEL_DESCRIPTIONS[phase.recommended]}</p>
                ...
                <button
                  ...
                  className="mt-2 inline-flex cursor-pointer items-center gap-1.5 text-xs text-slate-500 dark:text-gray-500 transition-colors hover:text-teal-300"
                >
