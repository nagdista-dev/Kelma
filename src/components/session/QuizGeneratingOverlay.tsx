...
import { BrainCircuit, Ear, Keyboard, Link2, PenLine, Sparkles } from 'lucide-react';
 ...
 * so the request is never interrupted.
 */
export function QuizGeneratingOverlay({ words }: QuizGeneratingOverlayProps) {
